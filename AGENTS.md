...
- 第一版 MVP、P5 连续生产与 P6 参考/知识闭环已实现，实际功能与验收以 `README.md`、`docs/MVP_ACCEPTANCE.md`、`docs/P5_ACCEPTANCE.md`、`docs/P6_ACCEPTANCE.md` 为准；DEVELOPMENT_SPEC 描述完整 V2，不代表49项均已实现。文档任务仍不得擅自启动额外产品开发。
