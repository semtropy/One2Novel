...
promptRegistry.register({
  ...
  contextRequirements: [
    ...
    { group: "story_macro", required: true, priority: 98 },
  ...
  contextPolicy: {
    requiredGroups: ["chapter_mission", "character_hard_facts", "style_contract", "story_macro", "book_contract"],
    preferredGroups: ["previous_chapter_hook", "open_conflicts", "recent_chapters", "payoff_directives", "story_macro", "character_dynamics", "rag_retrieval"],
  },
  systemPrompt: [
    "你是中文长篇网络小说写作助手。",
    ...
    "",
    "【篇幅要求】",
    "1. 本章目标字数：2000-3000字（标准连载章）。过渡章可短至1500字，高潮章如有多场景可连续多章完成。",
    "2. 不得为凑字数而填充无关描写或重复信息。",
    "",
    "【结构要求】",
...
promptRegistry.register({
  ...
  systemPrompt: [
    ...
    "- openingType（开场方式）：本章第一段/第一句的开场类型",
    "  · action：以动作或事件直接开场（\"他从墙上取下剑...\"）",
    "  · dialogue：以对话开场（\"'你来了。'他没有回头。\"）",
    "  · environment：以环境或场景描写开场（\"雨已经下了三天...\"）",
    "  · internal：以内心独白或心理活动开场（\"他不知道自己还能撑多久...\"）",
    "  · exposition：以说明性文字或背景介绍开场（\"大奉王朝延续三百年...\"）",
    "",
    "【标注原则】",
    "1. 基于可见内容判断，不推测后续章节",
